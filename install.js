...
const release = (
  ...
  pkg['ffmpeg-static-installer']['binary-release-tag']
)
const releaseName = (
  pkg['ffmpeg-static-installer']['binary-release-name'] ||
  release
)
...
const downloadsUrl = (
	...
	'https://github.com/blogwy/ffmpeg-static-installer/releases/download'
)
